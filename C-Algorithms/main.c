// ============================================================================
// FILE: main.c - LINEAR REGRESSION BEFORE KNN + UNIFIED TABLE (KNN COMMENTED OUT)
// ============================================================================
#include <stdio.h>
#include <stdlib.h>
...
//used for main program that calls C algorithms
...
int main(int argc, char *argv[]) {
    ...
    //printf("========================================\n");
    //printf("Machine Learning Library - ALL MODELS\n");
    //printf("========================================\n\n");
    printf("CSV file: %s\n", csv_path);
    ...
    //printf("\n========================================\n");
    //printf("STEP 3: Feature Normalization\n");
    //printf("========================================\n");
    Stats S;
    zscore(&Xtr, &S);
    apply_stats(&Xte, &S);
    //printf("Z-score normalization complete\n\n");
    ...
    // knn this one slow
    printf("5. K-Nearest Neighbors (k=7)\n");
    printf("   Predicting...");
    fflush(stdout);
    int pred_knn[MAX_ROWS];
    //knn_predict(&Xtr, ytr_int, &Xte, 7, 1, 0, 0, 1e-6, pred_knn);
    ...
    save_results_to_csv("model_results.csv", 
                        acc_log, f1_log,
                        acc_nb, f1_nb,
                        acc_tree, f1_tree,
                        rmse_lin, r2_lin,
