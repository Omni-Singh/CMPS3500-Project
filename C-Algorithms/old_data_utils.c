// ============================================================================
// FILE: data_utils.c
// Purpose: Implementation of data loading and preprocessing
// ============================================================================
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void load_and_encode_csv(const char *path, const char *target_col,
    ...
    // Prepare feature headers (without target)
    ...
    for (int i = 0; i < row; i++) {
        y[i] = (double)map_income_to_binary(raw_target[i]);
    }
